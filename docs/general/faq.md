...
- [How to keep my project up-to-date with `react-redefine`?](#how-to-keep-my-project-up-to-date-with-react-redefine)
...
## How to keep my project up-to-date with `react-redefine`?

While it's possible to keep your project up-to-date or "in sync" with `react-redefine`, it's usually
...
Submit an [issue](https://github.com/react-redefine/react-redefine/issues),
hop onto the [Spectrum chat](https://spectrum.chat/react-redefine)
