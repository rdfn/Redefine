...
**Note:** Based off of react-redefine **v3.4**

## Removing redux

There are a few reasons why we chose to bundle redux with React redefine, the
...
React redefine is a baseline for _your_ app: go for it!
